...
{
    public partial class AspNetCoreEdentityDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserrClaims", x => x.Id);
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "DataCreated",
                value: new DateTime(2024, 1, 6, 17, 31, 16, 774, DateTimeKind.Local).AddTicks(4468));
        }
    }
}
